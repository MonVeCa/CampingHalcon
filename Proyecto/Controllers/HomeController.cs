...
namespace ProyectoTest.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Empleado()
        {
            ...
            try
            {
                #region Mostrar datatable de SQL Server
                string cadena = "Data Source=DESKTOP-7F3VP04\\SQLEXPRESS;Initial Catalog=DB_CARRITO;Integrated Security=True";
                SqlConnection con = new SqlConnection(cadena);
                string sentencia = "SELECT IdUsuario, Nombres, Apellidos, Correo, FechaRegistro FROM USUARIO WHERE EsAdministrador ='true'";
